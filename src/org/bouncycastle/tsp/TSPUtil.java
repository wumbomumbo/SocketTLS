...
import bcjavastub.util.ArrayList;
import bcjavastub.util.Collection;
import bcjavastub.util.Collections;
import bcjavastub.util.HashMap;
import bcjavastub.util.List;
...
public class TSPUtil
{
    ...
    static List getExtensionOIDs(Extensions extensions)
    {
        ...
        return Collections.unmodifiableList(bcjavastub.util.Arrays.asList(extensions.getExtensionOIDs()));
    }
