...
{
    private static bcjavastub.math.BigInteger REGULAR = new bcjavastub.math.BigInteger("01020304ffffffff0506070811111111", 16);
    private static bcjavastub.math.BigInteger ANDROID = new bcjavastub.math.BigInteger("1111111105060708ffffffff01020304", 16);
    private static bcjavastub.math.BigInteger CLASSPATH = new bcjavastub.math.BigInteger("3020104ffffffff05060708111111", 16);
    ...
    static
    {
        bcjavastub.math.BigInteger check1 = new bcjavastub.math.BigInteger(128, new RandomChecker());
        bcjavastub.math.BigInteger check2 = new bcjavastub.math.BigInteger(120, new RandomChecker());
